...
def build_parser() -> argparse.ArgumentParser:
    ...
    evidence.add_argument("--fixture-update", action="store_true", help="Update one existing route-owned queue-runner fixture text file.")
    evidence.add_argument("--normalize-agent-run", action="store_true", help="Normalize EOF/trailing whitespace on one existing route-owned agent-run Markdown record.")
    ...
    evidence.add_argument("--target", dest="receipt_target", help="Root-relative evidence target for --receipt-refresh, --retarget-ref, --fixture-update, or --normalize-agent-run.")
    ...
    evidence.add_argument("--text", dest="fixture_text", help="Reviewed queue-runner fixture text for --fixture-update.")
    evidence.add_argument("--text-file", dest="fixture_text_file", help="UTF-8 reviewed queue-runner fixture text file for --fixture-update; use - for stdin.")
    ...
    evidence.add_argument("--input-ref", dest="input_refs", action="append", default=[], help="Root-relative input route or source path. Use product-source:<rel> for configured product_source_root files. May be repeated.")
    evidence.add_argument("--output-ref", dest="output_refs", action="append", default=[], help="Root-relative output evidence or source path. Use product-source:<rel> for configured product_source_root files. May be repeated.")
    evidence.add_argument("--claimed-path", dest="claimed_paths", action="append", default=[], help="Root-relative path claimed or changed by the run. Use product-source:<rel> for configured product_source_root files. May be repeated.")
    evidence.add_argument("--changed-file", dest="changed_files", action="append", default=[], help="Root-relative file changed by the run. Use product-source:<rel> for configured product_source_root files. May be repeated.")
    ...
    research_import.add_argument("--title", help="Research artifact title and default filename slug.")
    research_import.add_argument("--adopt-existing", action="store_true", help="Adopt one existing project/research/*.md target by adding route-visible metadata when needed.")
    research_import_text = research_import.add_mutually_exclusive_group()
