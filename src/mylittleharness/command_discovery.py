...
COMMAND_INTENTS: tuple[CommandIntent, ...] = (
    ...
    CommandIntent(
        ...
        "Preview an exact row-field or legacy table update for an existing decision or incubation tracker.",
        (
            "route-update",
            "tracker update",
            "ledger update",
        ...
        "mylittleharness --root <root> route-update --dry-run --target project/plan-incubation/<tracker>.md --match-column ID --match-value \"<existing-id>\" --field \"<table-column>\" --value \"<reviewed-line>\"",
        (
            "mylittleharness --root <root> route-update --apply --target project/plan-incubation/<tracker>.md --match-column ID --match-value \"<existing-id>\" --field \"<table-column>\" --value \"<reviewed-line>\" --proposal-token <ru-token-from-dry-run>",
            ...
            "mylittleharness --root <root> route-update --dry-run --target project/plan-incubation/<tracker>.md --table-heading \"<heading>\" --append-row \"| <cell> | <cell> |\"",
            "mylittleharness --root <root> route-update --dry-run --target project/plan-incubation/<tracker>.md --match-column ID --match-value \"<existing-id>\" --adopt-row-id <id>",
        ),
        "live operating root with existing direct project/decisions/*.md or project/plan-incubation/*.md tracker row marker or simple Markdown pipe table",
        "route-update edits one exact row field/table cell, optional inline adoption marker, or reviewed table append only; it cannot replace Markdown bodies, create files, approve lifecycle movement, archive, staging, commit, push, provider routing, or release",
    ),
    CommandIntent(
