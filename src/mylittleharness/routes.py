...
LIVE_LIFECYCLE_ROUTES: tuple[MemoryRoute, ...] = (
    ...
    MemoryRoute(
        "worker-run-receipts",
        "project/verification/worker-run-receipts/*.json",
        "repo-visible worker runtime receipt evidence with source-bound checkpoint refs",
        "at explicit worker receipt refresh or checkpoint review",
        "evidence",
    ),
    MemoryRoute(
        "approval-decisions",
        "project/decisions/owner-decisions/*.json",
        "repo-visible MLH-owned owner-decision records bound to approval-packet evidence by hash",
        "at explicit owner decision record",
        "decision evidence",
    ),
    MemoryRoute(
        "standing-delegations",
        "project/decisions/standing-delegations/*.json",
        "repo-visible bounded autonomy policies for later explicit route consumption",
        "at explicit standing delegation record",
        "policy evidence",
    ),
    MemoryRoute(
        "approval-packets",
...
ROLE_TO_ROUTE_ID = {
    ...
    "standing-delegation": "standing-delegations",
    "decision": "decisions",
    "docmap": "docs-routing",
    "handoff": "handoffs",
    ...
    "worker-run-receipt": "worker-run-receipts",
    "project-state": "state",
    "roadmap": "roadmap",
    "research": "research",
...
_ROUTE_MUTABILITY = {
    ...
    "worker-run-receipts": "worker-run-receipt-refresh-apply-rail",
    "attachments": "attachment-import-apply-rail",
    "approval-decisions": "approval-decision-apply-rail",
    "approval-packets": "approval-packet-apply-rail",
    "standing-delegations": "standing-delegation-apply-rail",
...
_ROUTE_GATE_CLASS = {
    ...
    "archive": "archive",
    "agent-runs": "evidence",
    "worker-run-receipts": "evidence",
    "attachments": "evidence",
    "approval-decisions": "authority",
    "approval-packets": "evidence",
    "standing-delegations": "authority",
    "handoffs": "evidence",
...
_ROUTE_ALLOWED_DECISIONS = {
    ...
    "worker-run-receipts": ("refresh", "inspect", "checkpoint"),
    "attachments": ("import", "inspect", "reference"),
    "approval-decisions": ("create", "inspect", "consume-explicit-ref"),
    "approval-packets": ("create", "inspect"),
    "standing-delegations": ("create", "inspect", "consume-explicit-ref"),
...
_ROUTE_ORCHESTRATION = {
    ...
    "worker-run-receipts": _EVIDENCE_ORCHESTRATION,
    "attachments": _EVIDENCE_ORCHESTRATION,
    "approval-decisions": _AUTHORITY_ORCHESTRATION,
    "approval-packets": _EVIDENCE_ORCHESTRATION,
    "standing-delegations": _AUTHORITY_ORCHESTRATION,
...
def classify_memory_route(rel_path: str, role: str = "") -> MemoryRoute:
    ...
    prefixes = (
        ...
        ("project/decisions/standing-delegations/", "standing-delegations"),
        ("project/decisions/owner-decisions/", "approval-decisions"),
        ("project/decisions/", "decisions"),
        ("project/drafts/", "drafts"),
        ("project/verification/worker-run-receipts/", "worker-run-receipts"),
