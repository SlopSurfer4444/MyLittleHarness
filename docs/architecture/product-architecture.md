...
The current productization milestone is a public GitHub source release at package version `1.0.3`. It validates the product boundary and verification baseline without declaring package-index publication, global installation, mutating workstation adoption, or standalone workstation mutation as part of the shipped runtime model.
